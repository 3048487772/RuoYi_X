...
public class VelocityUtils {
    ...
    public static List<String> getTemplateList(String tplCategory) {
        ...
        templates.add(folder+"/java/mapper.java.vm");
        templates.add(folder+"/java/service.java.vm");
        templates.add(folder+"/java/serviceImpl.java.vm");
        templates.add(folder+"/java/controller.java.vm");
        templates.add(folder+"/xml/mapper.xml.vm");
        templates.add(folder+"/js/api.js.vm");
        if (GenConstants.TPL_CRUD.equals(tplCategory)) {
            templates.add(folder+"/vue/index.vue.vm");
        } else if (GenConstants.TPL_TREE.equals(tplCategory)) {
            templates.add(folder+"/vue/index-tree.vue.vm");
    ...
    public static String getFileName(String template, GenTable genTable) {
        return getFileName(template, genTable, true);
    }

    /**
     * 获取文件名
     */
    public static String getFileName(String template, GenTable genTable, boolean gen) {
        // 文件名称
        String fileName = "";
        // 包路径
        String packageName = genTable.getPackageName();
        ...
        // 小写类名
        String lowerCaseClassName = StringUtils.uncapitalize(genTable.getClassName());
        // 业务名称
        String businessName = genTable.getBusinessName();
        ...
        if (template.contains("createVO.java.vm")) {
            fileName = StringUtils.format("{}/domain/{}VO/{}CreateVO.java" , javaPath, lowerCaseClassName, className);
        }
        if (template.contains("updateVO.java.vm")) {
            fileName = StringUtils.format("{}/domain/{}VO/{}UpdateVO.java" , javaPath, lowerCaseClassName, className);
        }
        if (template.contains("resultVO.java.vm")) {
            fileName = StringUtils.format("{}/domain/{}VO/{}ResultVO.java" , javaPath, lowerCaseClassName, className);
        }
        ...
        if (template.contains("importVO.java.vm")) {
            fileName = StringUtils.format("{}/domain/{}VO/{}ImportVO.java" , javaPath, lowerCaseClassName, className);
        }
